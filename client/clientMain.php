...
?>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link a-black" id="a-form-tab" data-toggle="tab" href="#form-tab" role="tab" aria-controls="form-tab" aria-selected="false" onclick="clearAllInputs(); <?php echo '\''.urlClientList.'\''?>;">Cadastrar</a>
        </li>
    </ul>
    <!-- Tab panes -->
                ...
                <form action="" class="row" >
                    <div class="col-8">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Pesquisar cliente por nome" id="inputSearch" name="inputSearch" >
                        </div>
                    </div>                    
                    <div class="col-4">                                        
